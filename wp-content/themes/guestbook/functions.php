<?php
    ...
    $enqueue_scripts->addCallback(
        function () {
            wp_localize_script(
                'guestbook-scripts', 'guestbook_params', [
    ...
    $media_templates = new Plugin_API_Manager('wp_footer');
    $media_templates->addCallback(
        function () {
            echo Template_Loader::load('template-parts/media-template');
        }
    );
